...
data <- fread('household_power_consumption.txt', sep = ';', header = FALSE, na.strings = '?', skip = "1/2/2007", nrows = 2880, col.names = c('Date', 'Time', 'Global_active_power', 'Global_reactive_power', 'Voltage', 'Global_intensity', 'Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), data.table = FALSE)
